...
namespace rental_services.Server.Controllers
{
    ...
    public class ServerInfoController : ControllerBase
    {
        ...
        {
            return Ok(_maintenanceService.IsActive ? null : new Models.DTOs.MaintenanceDTO() { Start = _maintenanceService.Start, End = _maintenanceService.End, Message = _maintenanceService.Message! });
        }
    }
}
