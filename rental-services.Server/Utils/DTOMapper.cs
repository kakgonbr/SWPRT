        ...
        public DTOMapper()
        {
            ...
            CreateMap<VehicleModel, VehicleModelDTO>()
                .ForMember(dest => dest.DisplayName, opt =>
                    opt.MapFrom(src => $"{src.Manufacturer.ManufacturerName} {src.ModelName}"
                    ))
                .ForMember(dest => dest.VehicleType, opt => opt.MapFrom(src => src.VehicleType.VehicleTypeName
                ))
                .ForMember(dest => dest.Shops, opt =>
                    opt.MapFrom(src =>
                        src.Vehicles.GroupBy(v => v.Shop.Address).Select(g => g.First().Shop.Address).ToList()
                    ))
                .ForMember(dest => dest.Rating, opt => opt.MapFrom(src => src.Reviews.Any()
            ...
            CreateMap<Booking, BookingDTO>()
                ...
                .ForMember(dest => dest.BikeImageUrl, opt => opt.MapFrom(src => src.Vehicle.Model.ImageFile
                ))
            ...
            CreateMap<BannerDTO, Banner>()
                .ForMember(dest => dest.Type, opt =>
                    opt.MapFrom(src => src.Type[0].ToString().ToUpper() + src.Type.Substring(1)
                    ))
